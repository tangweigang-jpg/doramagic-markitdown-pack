...
This repository is an independent AI context resource pack for microsoft/markitdown. It is not MarkItDown's official security contact.
...
Upstream product vulnerabilities should be reported to microsoft/markitdown's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
